...
public class CategoryController {
    ...
    public String list(@RequestParam(value = "sortType", defaultValue = "auto") String sortType,
        ...
        Page<Category> dicts = dictService.getEntityPage(searchParams, pageNumber, PAGE_SIZE, sortType);
    ...
    public String createForm(Model model) {
        model.addAttribute("dict", new Category());
    ...
    public String create(@Valid Category newDict, RedirectAttributes redirectAttributes) {
    ...
    public String updateForm(@PathVariable("id") Long pkId, Model model){
        Category dict =  dictService.findOne(pkId);
    ...
    public String update(@Valid Category dict, RedirectAttributes redirectAttributes){
        Long pkId = dict.getId();
        Category newDict = dictService.findOne(pkId);

        newDict.setSort(dict.getSort());
        newDict.setStatus(dict.getStatus());
